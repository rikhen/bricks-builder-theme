				...
				<tr>
					...
					<td>
						<div class="input-wrapper">
							...
							<a class="button" href="<?php echo $_SERVER['REQUEST_URI'] . '&sync_fonts#tab-api-keys'; ?>"><?php esc_html_e( 'Sync fonts', 'bricks' ); ?></a>
							<?php } ?>
						</div>
							...
							if ( isset( $_GET['sync_fonts'] ) ) {
								...
								// Typekit success
									...
									foreach ( $typekit->kit->families as $font ) {
										$typekit_fonts[] = json_decode( json_encode( $font ), true );
									}
