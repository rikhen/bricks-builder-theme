...
function bricks_update_nav_menu_item( $menu_id, $menu_item_db_id ) {
	...
	$mega_menu_template_id = isset( $_POST['bricks_mega_menu_template_id'][$menu_item_db_id] ) ? $_POST['bricks_mega_menu_template_id'][$menu_item_db_id] : '';
	...
	$mega_menu_template_id = isset( $_POST['bricks_multilevel'][$menu_item_db_id] ) ? $_POST['bricks_multilevel'][$menu_item_db_id] : '';
